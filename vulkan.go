...
// EnumerateInstanceVersion function as declared in https://www.khronos.org/registry/vulkan/specs/1.0/man/html/vkEnumerateInstanceVersion.html
func EnumerateInstanceVersion(pApiVersion *uint32) Result {
	cpApiVersion, cpApiVersionAllocMap := (*C.uint32_t)(unsafe.Pointer(pApiVersion)), cgoAllocsUnknown
	__ret := C.callVkEnumerateInstanceVersion(cpApiVersion)
	runtime.KeepAlive(cpApiVersionAllocMap)
	__v := (Result)(__ret)
	return __v
}
...
func EnumerateInstanceExtensionProperties(pLayerName string, pPropertyCount *uint32, pProperties []ExtensionProperties) Result {
	cpLayerName, cpLayerNameAllocMap := unpackPCharStringEmptyStringNil(pLayerName)
...
func CmdBuildAccelerationStructures(commandBuffer CommandBuffer, infoCount uint32, pInfos *AccelerationStructureBuildGeometryInfo, ppBuildRangeInfos [][]AccelerationStructureBuildRangeInfo) {
	...
	cppBuildRangeInfos, cppBuildRangeInfosAllocMap := unpackArgSSAccelerationStructureBuildRangeInfo(ppBuildRangeInfos)
